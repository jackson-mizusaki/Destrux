...
namespace Destrux {
	...
	class HDS, class Alloc, class NamedParameters>
		bool
		write_off(std::ostream& out, const CGAL::Polyhedron_3<Traits, Items, HDS, Alloc>& P, const NamedParameters& np) {
	...
	class HDS, class Alloc>
		bool
		write_off(std::ostream& out, const CGAL::Polyhedron_3<Traits, Items, HDS, Alloc>& P) {
	...
	class HDS, class Alloc,
		...
		read_off(std::istream& in,
			CGAL::Polyhedron_3<Traits, Items, HDS, Alloc>& P,
			NamedParameters np) {
	...
	class HDS, class Alloc>
		std::ostream&
		operator<<(std::ostream& out, const CGAL::Polyhedron_3<Traits, Items, HDS, Alloc>& P)
	{
		write_off(out, P);
		return out;
	}
